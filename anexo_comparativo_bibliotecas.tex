...
Este estudio plantea \textbf{diez hipótesis} sobre la transformación de las bibliotecas privadas entre 1518 y 1811:

\begin{enumerate}[label=\textbf{H\arabic*:}]
\item \textbf{Crecimiento exponencial:} El tamaño medio de las bibliotecas de élite experimenta un crecimiento exponencial entre 1518 y 1811 (de 331 a 5.166 obras, +1.460\%), reflejando la expansión del mercado editorial europeo y la consolidación de una cultura lectora en las élites burocráticas.

\item \textbf{Transición lingüística:} Se produce una transición gradual desde el predominio absoluto del latín (>90\% en s. XVI) hacia un equilibrio latino-vernáculo (57\% latín, 29\% español, 11\% francés en 1791), con el francés emergiendo como lengua de la Ilustración.

\item \textbf{Especialización funcional:} Las bibliotecas evolucionan desde colecciones especializadas del Renacimiento (imprenta profesional, devoción nobiliaria) hacia megabibliotecas enciclopédicas de la Ilustración, reflejando el ideal del \textit{philosophe} políglota y universal.

\item \textbf{Capital cultural burocrático:} La biblioteca deja de ser bien suntuario de la alta nobleza para convertirse en herramienta profesional de la magistratura borbónica, con las megabibliotecas (>5.000 obras) concentradas en Camaristas, Fiscales y Ministros.

\item \textbf{Concentración extrema:} El 20\% superior de las bibliotecas (Q5) concentra el 83,6\% de todas las obras catalogadas, evidenciando una distribución piramidal extremadamente desigual del capital cultural librario, con el top 10\% acumulando 200 veces más obras que el bottom 10\%.

\item \textbf{Brecha de género:} Las bibliotecas femeninas (condesas, aristócratas) son significativamente más pequeñas que las masculinas (media: 293 vs 1.364 obras, ratio 1:4,65), reflejando las restricciones patriarcales en el acceso femenino al conocimiento y la educación formal.

\item \textbf{Aceleración barroca:} El mayor salto cuantitativo se produce en el Barroco tardío (1650-1699), con un crecimiento del 208\% respecto al Barroco temprano, coincidiendo con el apogeo de la imprenta europea y la consolidación de redes comerciales transeuropeas del libro.

\item \textbf{Profesionalización magistral:} Las cuatro mayores bibliotecas individuales (excluida la institución eclesiástica) pertenecen a magistrados (Ramírez de Prado 8.951, Velasco 7.323) o nobles-diplomáticos con funciones burocráticas (Gondomar 6.471), no a la alta nobleza ociosa.

\item \textbf{Desaparición del modelo devocional:} Las microbibliotecas devocionales nobiliarias (<100 obras, exclusivamente religiosas) desaparecen tras 1600, sustituidas por bibliotecas profesionales mínimas de 150-300 obras con contenido secular dominante.

\item \textbf{Biblioteca como ascenso social:} La acumulación libraria se correlaciona positivamente con la movilidad social ascendente en la administración borbónica: los \textit{letrados} sin título nobiliario (Campomanes, Jovellanos) superan en capital cultural a duques y marqueses tradicionales.
\end{enumerate}
...
\subsection{Análisis por períodos cronológicos (corpus completo)}

El análisis diacrónico de las 42 bibliotecas revela patrones claros de transformación:

\begin{table}[h]
\centering
\begin{tabular}{lrrrr}
\toprule
\textbf{Período} & \textbf{N bibl.} & \textbf{Media} & \textbf{Min} & \textbf{Max} \\
\midrule
Renacimiento (1518-1549) & 5 & 331 & 60 & 582 \\
Siglo de Oro temprano (1550-1599) & 13 & 343 & 31 & 793 \\
Barroco temprano (1600-1649) & 14 & 752 & 47 & 6.471 \\
Barroco tardío (1650-1699) & 5 & 2.317 & 31 & 8.951 \\
Ilustración (1750-1811) & 5 & 5.166 & 514 & 7.323 \\
\midrule
\textbf{Crecimiento total} & \textbf{--} & \textbf{+1.460\%} & \textbf{--} & \textbf{--} \\
\bottomrule
\end{tabular}
\caption{Evolución cronológica del tamaño medio de bibliotecas (corpus 42)}
\end{table}

\textbf{Interpretación:}

\begin{enumerate}
\item \textbf{Estabilidad renacentista} (331-343 obras): Entre 1518 y 1599 el tamaño medio se mantiene estable, con bibliotecas pequeñas y especializadas.

\item \textbf{Despegue barroco} (752 obras, +119\%): En el Barroco temprano (1600-1649) se duplica el tamaño medio. La imprenta se consolida, los precios bajan, las redes comerciales se expanden.

\item \textbf{Aceleración tardía} (2.317 obras, +208\%): El Barroco tardío (1650-1699) experimenta el mayor salto relativo. Aparecen las primeras megabibliotecas (Ramírez de Prado 8.951, Gondomar 6.471).

\item \textbf{Consolidación ilustrada} (5.166 obras, +123\%): La Ilustración (1750-1811) culmina el proceso con bibliotecas enciclopédicas de 5.000-7.000 obras como norma en la alta magistratura.
\end{enumerate}

\subsection{Análisis por perfiles socioprofesionales}

\begin{table}[h]
\centering
\begin{tabular}{lrrrr}
\toprule
\textbf{Perfil social} & \textbf{N} & \textbf{Total obras} & \textbf{Media} & \textbf{Mediana} \\
\midrule
\rowcolor{yellow!20}
Alto clero/Instituciones & 2 & 7.859 & 3.930 & 3.930 \\
\rowcolor{yellow!20}
Humanistas/Eruditos & 4 & 2.029 & 507 & 492 \\
\rowcolor{green!20}
Alta nobleza titulada & 15 & 11.404 & 760 & 221 \\
Nobleza femenina & 3 & 880 & 293 & 216 \\
Literatos & 2 & 377 & 188 & 188 \\
Artistas & 2 & 201 & 100 & 100 \\
Otros nobles/Caballeros & 13 & 31.531 & 2.425 & 530 \\
Profesionales del libro & 1 & 525 & 525 & 525 \\
\bottomrule
\end{tabular}
\caption{Distribución del corpus por perfil socioprofesional}
\end{table}

\textbf{Observaciones clave:}

\begin{itemize}
\item \textbf{Alto clero (media: 3.930)}: Las instituciones eclesiásticas (Monasterio de San Martín 7.119) y los obispos (Frago 740) mantienen las mayores colecciones corporativas, con fuerte presencia de patrística y teología escolástica.

\item \textbf{Humanistas (media: 507)}: Los eruditos profesionales (Simón Abril, Argote de Molina, Caro) mantienen bibliotecas medianas especializadas en clásicos, filología y antigüedades.

\item \textbf{Alta nobleza titulada (media: 760, mediana: 221)}: A pesar de su riqueza, los duques y marqueses tienen bibliotecas relativamente pequeñas. La mediana de 221 obras evidencia que la mayoría posee colecciones modestas, con solo excepciones (Duque de Calabria 793, Marqués del Cenete 582).

\item \textbf{Brecha de género (293 vs 1.364)}: Las mujeres aristocráticas (condesas, aristócratas) tienen bibliotecas 4,65 veces más pequeñas que los varones, reflejando la exclusión femenina de la educación formal y la universidad.

\item \textbf{Literatos y artistas (100-200)}: Sorprendentemente, escritores (Quevedo 189, Inca Garcilaso 188) y pintores (Velázquez 154, El Greco 47) tienen bibliotecas pequeñas. Su capital es \textit{creativo}, no erudito.
\end{itemize}

\subsection{Estratificación por tamaño: análisis de quintiles}

\begin{table}[h]
\centering
\begin{tabular}{lrrrr}
\toprule
\textbf{Quintil} & \textbf{Media} & \textbf{Total} & \textbf{\% corpus} & \textbf{Interpretación} \\
\midrule
Q1 (0-20\%) & 49 & 395 & 0,7\% & Microbibliotecas \\
Q2 (20-40\%) & 127 & 1.016 & 1,9\% & Bibliotecas mínimas \\
Q3 (40-60\%) & 271 & 2.443 & 4,5\% & Bibliotecas profesionales \\
Q4 (60-80\%) & 626 & 5.007 & 9,3\% & Bibliotecas eruditas \\
\rowcolor{yellow!30}
Q5 (80-100\%) & 5.022 & 45.198 & 83,6\% & Megabibliotecas \\
\midrule
\textbf{Total} & \textbf{1.287} & \textbf{54.059} & \textbf{100\%} & \\
\bottomrule
\end{tabular}
\caption{Estratificación por quintiles (distribución extremadamente desigual)}
\end{table}

\textbf{Análisis de concentración:}

El quintil superior (Q5, 20\% de las bibliotecas) concentra el \textbf{83,6\% de todas las obras catalogadas}. Esta distribución piramidal extrema evidencia que:

\begin{enumerate}
\item El capital cultural librario se concentra en una \textbf{élite microscópica} (9 bibliotecas de 42).

\item Las 4 bibliotecas del top 10\% (Ramírez de Prado, Velasco, Monasterio, Gondomar) poseen 29.864 obras (\textbf{55,2\% del corpus total}), 200 veces más que las 4 del bottom 10\% (149 obras, 0,3\%).

\item La distribución es \textbf{más desigual} que la típica distribución de riqueza material en el Antiguo Régimen (donde el Gini oscila 0,4-0,5). El capital librario presenta una concentración extrema.
\end{enumerate}

\subsection{Análisis de género: la exclusión femenina del conocimiento}

\begin{table}[h]
\centering
\begin{tabular}{lrrr}
\toprule
\textbf{Género} & \textbf{N bibliotecas} & \textbf{Media} & \textbf{Total} \\
\midrule
Femeninas & 3 & 293 & 880 \\
Masculinas & 39 & 1.364 & 53.179 \\
\midrule
\textbf{Ratio M/F} & \textbf{13:1} & \textbf{4,65:1} & \textbf{60,4:1} \\
\bottomrule
\end{tabular}
\caption{Brecha de género en el acceso al libro}
\end{table}

Las tres bibliotecas femeninas documentadas son:

\begin{itemize}
\item \textbf{Mencía de Mendoza} (616 obras, 1553/1562): Aristócrata culta, excepcional. Su biblioteca es 2x superior a la media femenina, reflejando su posición en círculos humanistas valencianos.

\item \textbf{Felipa de Villalba} (216 obras, 1626): Nobleza urbana madrileña. Biblioteca mediana con presencia de literatura devocional y profana.

\item \textbf{Beatriz de Castro, condesa de Lemos} (48 obras, 1570): Biblioteca devocional típica de la alta nobleza femenina del XVI.
\end{itemize}

\textbf{Conclusión:} La exclusión femenina de la universidad, los colegios y las profesiones liberales se refleja en un acceso extremadamente restringido al capital librario. Las mujeres aristocráticas, incluso con recursos económicos ilimitados, acumulan bibliotecas 4,65 veces más pequeñas que los varones de su mismo estamento.
