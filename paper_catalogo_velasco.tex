...
\begin{quote}
``Fernandez de Velasco (D. Bernardino) Advertencias y ala Historia de España del Padre Mariana 4° citad 1613 N° 134 12''
\end{quote}

\begin{quote}
``Velasco (D. Pedro Fernandez) Segundo de Tordesillas, con una Sumaria Relacion del Linaje de Velasco por Pedro Mantuano f. Milan 1671 V. 198 20''
\end{quote}
...
\begin{quote}
``Antonio Baylo Madrid, 4 de octubre de 1791 Dijo yo el abajo firmado que he visto reconocido y tasado los libros contenidos en este catalogo 2 tomos en folio y fueron del Sr. D. Fernan de Velasco del Consejo y Camara de S.M. A lo qual se ha dado el valor segun mi respectivo estado y mi saber y entender.''
\end{quote}
...
\begin{quote}
``Colmenares (Diego de) Historia de la Ciudad de Segovia, y de Castilla fol. Madrid. 1640 - Numero 143 60''
\end{quote}
...
\begin{quote}
``Vegetii (Flavii) De Re Militari 4.º Antuerpiae 1585. figuras. c. 68 75''
\end{quote}
