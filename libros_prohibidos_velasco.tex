...
\begin{quote}
\textbf{``Itt. Librorum prohibitorum a Benedicto XIV 4° Romae 1758 N°112 12''}
\end{quote}
...
\begin{quote}
``Voltaire (M. de) Lettres de quelques juifs Portugais, Allemands, et Polonois: 8.° 3 tom.  A la Rustica Paris 1781 N. 173 42''
\end{quote}

Esta obra contiene críticas devastadoras al cristianismo, presentadas en forma epistolar satírica.

\begin{quote}
``Voltaire (M. de) Id. El Oráculo de los nuevos Filósofos traducido al Español p. el P. Fr. Pedro Morzo 1769 4.° 2 tom. Madrid n. 79 32''
\end{quote}

Lo más notable es que esta obra está \textbf{traducida al español por un fraile} (P. Fr. Pedro Morzo). Esto sugiere una estrategia de refutación: traducir a Voltaire para poder combatirlo mejor. Sin embargo, el mero hecho de poseer estas obras ---incluso en versión ``refutativa''--- era sospechoso.
...
\begin{quote}
\textbf{``Boxhornii (Marci Ziræii) Institutiones Politicae. 4º. Regio monte 1678. N. 67 15''}
\end{quote}
...
\begin{itemize}
    \item Las obras de Voltaire tienen precios medios-altos (42 reales)
