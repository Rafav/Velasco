...
\begin{table}[h]
\centering
\caption{Completitud de campos del catálogo (catalogo\_depurado\_v2.csv)}
...
\textbf{Nota:} La versión 2 del catálogo depurado corrigió 314 entradas donde el lugar de impresión (principalmente ``Mad.'' para Madrid) había sido mal parseado en el campo título. Esto mejoró la completitud del campo lugar del 44,7\% al 49,0\%.
...
Del total de 7.323 obras, 3.312 (45,2\%) tienen lugar de impresión identificado y normalizado (excluyendo las 260 entradas con ``ibid''). La Tabla \ref{tab:paises} presenta la distribución por países:
...
Portugal & 66 & 0,90\% \\
Otros (Reino Unido, Malta, Ginebra) & 20 & 0,27\% \\
\midrule
\textbf{Total identificado} & \textbf{3.312} & \textbf{45,2\%} \\
Sin identificar & 4.011 & 54,8\% \\
\midrule
...
El claro predominio español (62\% de los lugares identificados) confirma el carácter hispánico de la colección. Los circuitos francés e italiano aparecen como proveedores complementarios importantes.

\subsubsection{Centros editoriales españoles}

España concentra 2.053 obras identificadas, distribuidas en doce ciudades. La Tabla \ref{tab:espana} detalla los principales centros:
...
Lugo & 6 & 0,29\% \\
\midrule
\textbf{Total España} & \textbf{2.053} & \textbf{100\%} \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Madrid} domina claramente con 1.196 obras (58,25\% del total español, 16,33\% del catálogo completo), confirmando su papel como capital editorial a partir de su establecimiento como capital del reino en 1561 por Felipe II. Este predominio se intensifica especialmente en el siglo XVIII, durante la Ilustración española. La corrección de 314 entradas mal parseadas (principalmente ``Mad.'' por Madrid) permitió revelar el verdadero peso de Madrid como centro editorial.
...
\midrule
Madrid (1.196) & 63,88\% & 8,36\% & 26,59\% & 1,17\% \\
...
La presencia dominante de Madrid (1.196 obras) y París (403 obras) documenta el eje cultural privilegiado durante la Ilustración española, especialmente bajo Carlos III y Carlos IV.
...
\begin{enumerate}
    ...
    \item \textbf{Madrid como capital editorial:} Con 1.196 obras (16,33\% del total, 58,25\% de las españolas), Madrid se consolida como el principal centro editorial hispánico, reflejando su papel como capital política y cultural desde 1561. La corrección de errores de parsing reveló la verdadera magnitud del predominio madrileño.
