...
La calidad general de los datos extraídos mediante OCR es buena, con una completitud promedio del 77,0\%. La Tabla \ref{tab:completitud} muestra el porcentaje de completitud para cada campo:
