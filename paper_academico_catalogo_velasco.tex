...
\title{
    {\Large\textbf{La Biblioteca del Camarista de Castilla}}\\
    {\Large\textbf{Fernando José de Velasco y Ceballos (1707-1788):}}\\[0.5cm]
    {\large Análisis Bibliométrico de 7.323 Obras (1427-1799)}\\
    {\large Geografía Editorial, Distribución Lingüística y Circulación del Libro}
}

\author{
    Análisis del Catálogo BNE MSS/13601-13602 (Tasación de 1791)\\[0.3cm]
...
\begin{abstract}
Este trabajo presenta un análisis bibliométrico exhaustivo de la biblioteca de Fernando José de Velasco y Ceballos (1707-1788), Camarista de Castilla, a partir del catálogo manuscrito conservado en la Biblioteca Nacional de España (MSS/13601-13602). La tasación realizada por Antonio Baylo en junio de 1791 documenta 7.323 obras impresas entre 1427 y 1799, proporcionando una ventana excepcional a la cultura libraria de un alto funcionario de la monarquía borbónica durante la Ilustración española. El análisis cuantitativo revela el predominio de Madrid como centro editorial (18,84\% de las obras identificadas), la importancia de los circuitos franceses (8,55\%) e italianos (3,82\%), y una transición gradual del latín (10,34\%) al castellano (70,46\%) como lengua de publicación. La biblioteca refleja el perfil de un erudito jurista vinculado a la alta administración, con particular concentración de obras en derecho, historia y literatura clásica. Este estudio contribuye al conocimiento de las bibliotecas particulares del siglo XVIII español y la geografía editorial de la Edad Moderna.

\medskip

\noindent\textbf{Palabras clave:} Historia del libro, Bibliotecas particulares, Camarista de Castilla, Bibliometría, Ilustración española, Geografía editorial, Fernando José de Velasco, Siglo XVIII.
\end{abstract}
...
El presente estudio examina la biblioteca de \textbf{Fernando José de Velasco y Ceballos} (1707-1788), destacado jurista y Camarista de Castilla durante los reinados de Fernando VI, Carlos III y Carlos IV. El catálogo manuscrito, conservado en la Biblioteca Nacional de España (BNE) bajo las signaturas \textbf{MSS/13601} (vol. 1, 166 hojas) y \textbf{MSS/13602} (vol. 2, 181 hojas), documenta 7.323 obras tasadas por Antonio Baylo en junio de 1791, tres años después de la muerte del propietario.

Esta colección es especialmente significativa por varias razones:

\begin{enumerate}
    \item \textbf{Perfil del propietario:} Como Camarista de Castilla, Velasco y Ceballos ocupó uno de los cargos más elevados de la administración de justicia española, formando parte de la Cámara de Castilla, órgano consultivo del rey en materias de gracia y justicia.

    \item \textbf{Contexto histórico:} La biblioteca se formó durante la Ilustración española (reinados de Fernando VI y Carlos III), período de reformismo borbónico y apertura cultural moderada.

    \item \textbf{Tamaño excepcional:} Con 7.323 obras, esta es una de las bibliotecas particulares más grandes documentadas del siglo XVIII español, comparable a las de otros ilustrados como Campomanes o Jovellanos.

    \item \textbf{Rango cronológico:} Abarca desde los incunables (1427) hasta finales del siglo XVIII (1799), ofreciendo una perspectiva de largo alcance sobre la acumulación bibliográfica.
\end{enumerate}

El catálogo ha sido estudiado previamente por Valentín Moreno Gallego (\textit{Burocracia y cultura libraria en el XVIII: el Camarista Velasco y su gran biblioteca}, 1998) y Mateo Escagedo Salmón (\textit{Biblioteca del Camarista de Castilla Don Fernando José de Velasco y Ceballos}, 1932), pero el presente análisis cuantitativo aporta nuevas perspectivas sobre la geografía editorial y la distribución lingüística.
...
La fuente primaria de este estudio es el \textbf{Catálogo de la biblioteca de D. Fernando José de Velasco y Ceballos, con la tasación que de ellos hizo D. Antonio Baylo, en junio de 1791}, manuscrito conservado en la Biblioteca Nacional de España:

\begin{itemize}
    \item \textbf{Signatura:} MSS/13601 (Volumen 1, 166 hojas) y MSS/13602 (Volumen 2, 181 hojas)
    \item \textbf{Fecha:} Junio de 1791
    \item \textbf{Tasador:} Antonio Baylo
    \item \textbf{Tipo:} Manuscrito en formato de inventario con precios tasados
    \item \textbf{Contenido:} 7.323 entradas bibliográficas correspondientes a obras impresas entre 1427 y 1799
\end{itemize}

El propietario, Fernando José de Velasco y Ceballos (1707-1788), falleció tres años antes de la tasación. El catálogo fue elaborado probablemente con fines testamentarios o de venta de la biblioteca. La tasación de Antonio Baylo proporciona información adicional sobre el valor comercial de las obras en el mercado librario madrileño de finales del siglo XVIII.

\subsection{Procesamiento de datos}

El catálogo manuscrito fue digitalizado y extraído mediante tecnología de reconocimiento óptico de caracteres (OCR). Las 7.323 entradas fueron procesadas y estructuradas en un formato de base de datos con los siguientes campos:
...
La calidad general de los datos extraídos mediante OCR es buena, con una completitud promedio del 79,4\%. La Tabla \ref{tab:completitud} muestra el porcentaje de completitud para cada campo:

\begin{table}[h]
\centering
\caption{Completitud de campos del catálogo (catalogo\_depurado\_v3.csv)}
...
\textbf{Nota sobre mejoras sucesivas:} El proceso de depuración pasó por tres versiones. La v2 corrigió 314 entradas donde el lugar estaba mal parseado en el campo título (mejora: 44,7\% → 49,0\%). La v3 extrajo 284 lugares adicionales desde el campo \texttt{transcripcion\_original}, llevando la completitud al 52,8\%. En total, 598 lugares de impresión fueron recuperados mediante análisis automatizado del texto OCR.
...
Del total de 7.323 obras, 3.595 (49,1\%) tienen lugar de impresión identificado y normalizado (excluyendo las 260 entradas con ``ibid''). La Tabla \ref{tab:paises} presenta la distribución por países:
...
\begin{tabular}{lcc}
\toprule
\textbf{País} & \textbf{Obras} & \textbf{Porcentaje del catálogo} \\
\midrule
España & 2.284 & 31,19\% \\
Francia & 626 & 8,55\% \\
Italia & 280 & 3,82\% \\
Países Bajos/Bélgica & 199 & 2,72\% \\
Alemania/Suiza & 100 & 1,37\% \\
Portugal & 67 & 0,91\% \\
Otros (Reino Unido, Malta, Ginebra) & 39 & 0,53\% \\
\midrule
\textbf{Total identificado} & \textbf{3.595} & \textbf{49,1\%} \\
Sin identificar & 3.728 & 50,9\% \\
\midrule
...
El claro predominio español (63,5\% de los lugares identificados) confirma el carácter hispánico de la colección. Los circuitos francés e italiano aparecen como proveedores complementarios importantes.

\subsubsection{Centros editoriales españoles}

España concentra 2.284 obras identificadas, distribuidas en doce ciudades. La Tabla \ref{tab:espana} detalla los principales centros:
...
Lugo & 6 & 0,26\% \\
\midrule
\textbf{Total España} & \textbf{2.284} & \textbf{100\%} \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Madrid} domina claramente con 1.380 obras (60,42\% del total español, 18,84\% del catálogo completo), confirmando su papel como capital editorial a partir de su establecimiento como capital del reino en 1561 por Felipe II. Este predominio se intensifica especialmente en el siglo XVIII, durante la Ilustración española. El proceso de depuración en tres etapas (v1→v2→v3) permitió recuperar 598 lugares de impresión, revelando que Madrid tenía 184 obras adicionales no detectadas inicialmente (15\% de incremento desde v2).

\textbf{Salamanca}, con 183 obras (8,01\% del total español), refleja la importancia de su universidad, fundada en 1218 y considerada una de las más antiguas de Europa. Su producción editorial se concentra en obras académicas, jurídicas y teológicas.

\textbf{Valencia} (141 obras, 6,17\%) y \textbf{Zaragoza} (139 obras, 6,09\%) representan importantes centros editoriales del reino de Valencia y la Corona de Aragón, respectivamente, con fuerte producción especialmente en el siglo XVI y primera mitad del XVII.

\textbf{Sevilla} (105 obras, 4,60\%) y \textbf{Alcalá de Henares} (101 obras, 4,42\%) completan el grupo de los cinco principales centros editoriales españoles. Alcalá destaca por su universidad fundada por el Cardenal Cisneros en 1499 y por ser sede de la impresión de la famosa Biblia Políglota Complutense (1514-1517).

\subsubsection{Centros editoriales franceses}

Francia aporta 626 obras (8,55\% del catálogo), concentradas principalmente en dos ciudades:
...
\midrule
Madrid (1.380) & 64,06\% & 8,12\% & 26,45\% & 1,38\% \\
París (420) & 57,86\% & 15,00\% & 26,43\% & 0,71\% \\
Salamanca (183) & 67,21\% & 11,48\% & 21,31\% & 0,00\% \\
Lyon (165) & 80,00\% & 12,73\% & 6,67\% & 0,61\% \\
Valencia (141) & 68,09\% & 9,93\% & 21,99\% & 0,00\% \\
Zaragoza (139) & 56,12\% & 10,79\% & 32,37\% & 0,72\% \\
Roma (138) & 76,09\% & 11,59\% & 8,70\% & 3,62\% \\
Venecia (135) & 80,00\% & 11,85\% & 5,93\% & 2,22\% \\
\bottomrule
\end{tabular}
\end{table}
...
El catálogo incluye miles de autores diferentes, con 1.781 obras anónimas (24,3\% del total). La identificación de autores mejoró significativamente gracias al procesamiento avanzado del catálogo v1, aumentando la completitud del 65,8\% al 75,7\%. La Tabla \ref{tab:autores} presenta los autores más prolíficos:
...
\midrule
Nebrija (Nebrixa), Antonio de & 28 & Humanista, autor de la primera gramática castellana (1492) \\
Agustín (Augustini), Antonio & 23 & Humanista, jurista y arzobispo de Tarragona \\
Enríquez (Henrici), Juan & 23 & Jurista y canonista \\
Cicerón (Ciceronis), Marco Tulio & 20 & Filósofo, orador y político romano \\
Colbert, Jean-Baptiste & 17 & Político francés, ministro de Luis XIV \\
Grocio (Grotii), Hugo & 15 & Jurista holandés, padre del derecho internacional \\
Mariana, Juan de & 15 & Historiador jesuita, autor de \textit{Historia general de España} \\
Lope de Vega & 13 & Dramaturgo del Siglo de Oro español \\
Covarrubias, Diego de & 12 & Jurista y obispo de Segovia \\
Justiniano, Emperador & 12 & Emperador romano, autor del \textit{Corpus Iuris Civilis} \\
\bottomrule
\end{tabular}
\end{table}
...
La presencia dominante de Madrid (1.380 obras) y París (420 obras) documenta el eje cultural privilegiado durante la Ilustración española, especialmente bajo Carlos III y Carlos IV.
...
Este análisis bibliométrico de la biblioteca de Fernando José de Velasco y Ceballos (1707-1788), Camarista de Castilla, proporciona una visión excepcional de la cultura libraria de un alto funcionario de la monarquía borbónica durante la Ilustración española. El catálogo de 7.323 obras (tasación de 1791) revela patrones significativos sobre la geografía editorial, la evolución lingüística y el perfil intelectual del propietario. Las principales conclusiones son:
...
\begin{enumerate}
    ...
    \item \textbf{Madrid como capital editorial:} Con 1.380 obras (18,84\% del total, 60,42\% de las españolas), Madrid se consolida como el principal centro editorial hispánico, reflejando su papel como capital política y cultural desde 1561. El proceso de depuración en tres etapas permitió recuperar 598 lugares de impresión mal parseados, revelando la verdadera magnitud del predominio madrileño.
    ...
    \item \textbf{Perfil del Camarista Velasco:} La biblioteca refleja el perfil de un alto funcionario jurista vinculado a la administración borbónica. Como Camarista de Castilla (órgano consultivo del rey en gracia y justicia), Velasco necesitaba una extensa biblioteca jurídica, histórica y literaria. La presencia de obras en derecho canónico, civil y político, junto con clásicos grecolatinos y literatura contemporánea, indica un erudito con formación humanística y práctica jurídica.

    \item \textbf{Ilustración moderada:} La presencia controlada de autores ilustrados (2 obras de Voltaire, 6 de Erasmo), junto con el predominio de ortodoxia (99,75\% de obras no prohibidas), sugiere un ilustrado cauteloso que operaba dentro de los límites de la censura inquisitorial, posiblemente con licencias oficiales para lectura de obras expurgadas.

    \item \textbf{Biblioteca excepcional:} Con 7.323 obras, esta es una de las bibliotecas particulares más grandes documentadas del siglo XVIII español, comparable solo a las de otros ilustrados de alto rango como Campomanes (Fiscal del Consejo de Castilla) o Jovellanos (Ministro de Gracia y Justicia). Su tamaño refleja tanto la posición social del propietario como su dedicación intelectual.

    \item \textbf{Acumulación generacional:} El amplio rango cronológico (1427-1799) y la presencia de incunables sugieren una colección formada a lo largo de décadas, posiblemente con acumulación familiar y adquisiciones estratégicas en el mercado anticuario.
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Biografía intelectual de Velasco:} Investigación archivística para reconstruir la trayectoria profesional, la red intelectual y los criterios de selección bibliográfica del Camarista.

    \item \textbf{Análisis temático exhaustivo:} Clasificación detallada de las obras por materias jurídicas, históricas, literarias y científicas para comprender el perfil intelectual específico.
...
Este trabajo ha sido posible gracias al catálogo manuscrito conservado en la Biblioteca Nacional de España (MSS/13601-13602). Agradecemos el trabajo previo de Valentín Moreno Gallego y Mateo Escagedo Salmón, cuyas investigaciones sobre la biblioteca del Camarista Velasco sentaron las bases para este análisis cuantitativo. Las tecnologías de procesamiento de texto mediante OCR y las herramientas de análisis de datos desarrolladas específicamente para este proyecto han permitido un análisis bibliométrico exhaustivo. Los scripts de Python utilizados están disponibles en el repositorio del proyecto.

\section{Referencias bibliográficas}

\subsection{Sobre la biblioteca de Velasco y Ceballos}

\begin{enumerate}
    \item Escagedo Salmón, Mateo. \textit{Biblioteca del Camarista de Castilla Don Fernando José de Velasco y Ceballos}. Santander: [s.n.], 1932.

    \item Moreno Gallego, Valentín. ``Burocracia y cultura libraria en el XVIII: el Camarista Velasco y su gran biblioteca'', en \textit{Trabajos de la Asociación Española de Bibliografía}, II (1998), pp. 125-168.

    \item Soto Pérez, José Luis. \textit{Arabismo e Ilustración: correspondencia literaria (1791-1803) de Fr. José Antonio Banqueri con Don Manuel de Cenáculo Vilas Boas, Obispo de Beja y Arzobispo de Évora}. Oviedo: BOCES XVIII, 1985 (Anejos del BOCES XVIII, 3).

    \item Andrés, Gregorio de. ``Fernández de Velasco'', en \textit{Catálogo de manuscritos de la Biblioteca Nacional}. Madrid: Biblioteca Nacional, [s.a.].

    \item Martín Abad, Julián. \textit{Bibliotecas particulares en la Edad Moderna}. Madrid: [s.n.], [s.a.].
\end{enumerate}

\subsection{Historia del libro y bibliotecas en España}
