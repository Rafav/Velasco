...
\large{en la Biblioteca del Camarista Velasco y Ceballos (1427-1799)}}
...
Este anexo presenta un análisis exhaustivo de los libros heréticos, prohibidos y controvertidos presentes en la biblioteca de \textbf{Fernando José de Velasco y Ceballos} (1707-1788), Camarista de Castilla. El catálogo manuscrito, tasado por Antonio Baylo en junio de 1791 (BNE MSS/13601-13602), documenta 7.323 obras impresas entre 1427 y 1799. El análisis se basa en los Índices de libros prohibidos de la Inquisición española, particularmente:
...
\subsection{Perfil de Fernando José de Velasco y Ceballos}

La presencia controlada de obras heterodoxas se explica perfectamente por el perfil del propietario:

\begin{itemize}
    \item \textbf{Alto funcionario:} Como Camarista de Castilla (órgano consultivo del rey en gracia y justicia), ocupaba uno de los cargos más elevados de la administración borbónica
    \item \textbf{Jurista erudito:} Su cargo requería extensa biblioteca jurídica, incluyendo derecho canónico, civil y político
    \item \textbf{Licencias inquisitoriales:} Por su cargo, tenía acceso legal a obras expurgadas y prohibidas necesarias para su función consultiva
    \item \textbf{Ilustrado moderado:} Interés por filosofía ilustrada (Voltaire), pero dentro de los límites de la ortodoxia (99,75\%)
    \item \textbf{Humanista:} La presencia de Erasmo (6 obras) refleja formación humanística típica de juristas del XVIII
    \item \textbf{Biblioteca profesional y personal:} La colección combinaba necesidades laborales (derecho, historia, política) con intereses intelectuales (literatura, filosofía)
\end{itemize}

\textbf{Comparación con otros Camaristas y fiscales:}

Fernando José de Velasco y Ceballos pertenecía al mismo estamento que Pedro Rodríguez de Campomanes (Fiscal del Consejo de Castilla, 1723-1802) y Gaspar Melchor de Jovellanos (Ministro de Gracia y Justicia, 1744-1811). Estos ilustrados de la alta administración tenían:

\begin{enumerate}
    \item Bibliotecas excepcionales (5.000-10.000 volúmenes)
    \item Licencias inquisitoriales por cargo
    \item Acceso a obras prohibidas con fines profesionales
    \item Perfil de ``ilustrados católicos'' o ``ilustrados moderados''
\end{enumerate}

La biblioteca de Velasco, con 7.323 obras y solo 18 prohibidas (0,25\%), se ajusta perfectamente a este perfil.
